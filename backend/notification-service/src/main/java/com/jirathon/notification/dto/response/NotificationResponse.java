...
public class NotificationResponse {
    ...
    public NotificationResponse(String id, String userId, String email, String fullName, NotificationType type,
                                ...
                                Instant readAt, Instant archivedAt) {
        this.id = id;
        this.userId = userId;
        this.email = email;
    ...
    public static final class Builder {
        ...
        public NotificationResponse build() {
            return new NotificationResponse(id, userId, email, fullName, type, status, title, message,
                    subject, relatedEntityId, relatedEntityType, metadata, emailSent, websocketSent,
                    createdAt, sentAt, readAt, archivedAt);
        }
    }
}
