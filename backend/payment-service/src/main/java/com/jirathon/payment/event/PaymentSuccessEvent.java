package com.jirathon.payment.event;
...
public class PaymentSuccessEvent {
    ...
    public PaymentSuccessEvent(String paymentTransactionId, String registrationId, String contestId,
                               String userId, double payableAmount, String payuTxnId, String payuPaymentId) {
